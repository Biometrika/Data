...
dt <- matrix(c(6.0,4.3,5.8,5.0,4.9,6.1,4.0,4.7,
...
rownames(dt) <- c("Cameo","Clipper","Betzes","LG30","LG10","LG16","LG32","LG8","LG31","LG17","LG22","LG33","LG34")
colnames(dt) <- c("IG86","IG75","IG87","QNB851","IG88","IG84","IG48","IG78")

# metod uglacane medijane ---
mod.fit <- medpolish(dt)
mod.fit$overall
mod.fit$row
mod.fit$col
mod.fit$residuals
